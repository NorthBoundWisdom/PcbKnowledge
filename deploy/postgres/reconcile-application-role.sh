...
unset PGPASSWORD admin_password application_password worker_password
echo "PostgreSQL application and worker roles are present without owner or RLS-bypass privileges."
